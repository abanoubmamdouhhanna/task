export const activationMail = (activationCode, protocol, host) => {
    const activationLink = `${protocol}://${host}/auth/confirm/${activationCode}`;
